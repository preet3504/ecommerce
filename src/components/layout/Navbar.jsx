      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-1">
            <Link href="/products" className="px-4 py-2 rounded-lg hover:bg-white/10 transition-all duration-300 flex items-center gap-2 group">
              <Search size={18} className="group-hover:scale-110 transition-transform" />
              <span>Products</span>
            </Link>
            <Link href="/orders" className="px-4 py-2 rounded-lg hover:bg-white/10 transition-all duration-300 flex items-center gap-2 group">
            ...
            <div className="hidden md:block relative">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-accent-200">View Profile</p>
                </div>
              </button>
        ...
        {showMobileMenu && (
          <div className="md:hidden py-4 border-t border-white/10 animate-slideDown">
            ...
            <Link href="/orders" className="block px-4 py-3 hover:bg-white/10 rounded-lg transition flex items-center gap-3">
              <Package size={18} />
              <span>Orders</span>
            </Link>
            ...
            <div className="border-t border-white/10 mt-2 pt-2">
              <Link href="/profile" className="block px-4 py-3 hover:bg-white/10 rounded-lg transition flex items-center gap-3">
                <User size={18} />
                <span>Profile</span>
              </Link>
              <button
